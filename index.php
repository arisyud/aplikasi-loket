...
<head>
	...
	<title>Data Transaksi Loket SMLink</title>
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text">LOKET SMLink</span>
			</a>
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item">
							<a href="?page=data_trx" class="nav-link">
						...
						<li class="nav-item">
							<a href="?page=data-pengaduan" class="nav-link">
								<i class="nav-icon far fa fa-users"></i>
								<p>
									Pengaduan Transaksi
								</p>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
              //Klik Halaman Home Pengguna
				...
				//Asrama
				case 'data_trx':
					include "admin/loket/data_trx.php";
					break;
				case 'add_trx':
					include "admin/loket/add_trx.php";
					break;
				case 'edit_trx':
					include "admin/loket/edit_trx.php";
					break;
				case 'del_trx':
					include "admin/loket/del_trx.php";
					break;
				case 'view_trx':
					include "admin/loket/view_trx.php";
					break;
				case 'data-pengaduan':
					include "admin/pengaduan/data-pengaduan.php";
					break;
				case 'tambah-pengaduan':
					include "admin/pengaduan/tambah-pengaduan.php";
					break;
				case 'edit-pengaduan':
					include "admin/pengaduan/edit-pengaduan.php";
					break;
				case 'hapus-pengaduan':
					include "admin/pengaduan/hapus-pengaduan";
					break;
				case 'lihat-pengaduan':
					include "admin/pengaduan/lihat-pengaduan.php";
					break;
